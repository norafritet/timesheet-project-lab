...
public class TimeSheetStories extends JUnitStories {

    public TimeSheetStories() {
        ...
        Configuration configuration = new SeleniumConfiguration().useSeleniumContext(seleniumContext)
                ...
                .useStoryLoader(new LoadFromClasspath(TimeSheetStories.class))
                .useStoryReporterBuilder(reporterBuilder);
        useConfiguration(configuration);

        ApplicationContext context = new SpringApplicationContextFactory("timesheet-steps.xml").createApplicationContext();
